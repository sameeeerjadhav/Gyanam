...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <div class="nav-section">
            ...
            <a href="sample_certificate.php" class="nav-link <?= $currentPage === 'sample_certificate.php' ? 'active' : '' ?>" data-tooltip="Sample Certificate">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><path d="M16 13H8"/><path d="M16 17H8"/><path d="M10 9H8"/></svg>
        ...
        <div class="nav-section">
            ...
            <a href="record_cash_share.php" class="nav-link <?= $currentPage === 'record_cash_share.php' ? 'active' : '' ?>" data-tooltip="Record Cash Share">
        ...
        <div class="nav-section">
            ...
            <a href="review_documents.php" class="nav-link <?= $currentPage === 'review_documents.php' ? 'active' : '' ?>" data-tooltip="Review Documents (TEMP)">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><circle cx="11" cy="13" r="2"/><path d="M14 13h3"/></svg>
                <span>Review Docs</span>
                <span style="margin-left:auto;background:#fef3c7;color:#92400e;border-radius:99px;font-size:.65rem;font-weight:800;padding:.1rem .45rem">TEMP</span>
            </a>
        </div>
